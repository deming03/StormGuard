...
import { severityUtils, disasterUtils, resourceUtils, dateUtils } from '@/lib/utils'
...
export default function DashboardPage() {
  ...
  const nearbyResources = resources.slice(0, 5)
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">
          Here's what's happening in your disaster management system today.
        </p>
      </div>
        ...
        <Card className="col-span-1 lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                Latest disaster reports and updates
              </CardDescription>
            </div>
            ...
            <div className="space-y-3">
              {nearbyResources.length === 0 ? (
                <div className="text-center text-muted-foreground py-4">
                  ...
                  <p className="text-sm">No medical resources available</p>
                </div>
              ) : (
                nearbyResources.map((resource) => (
                  <div key={resource.id} className="p-3 rounded-lg border hover:bg-muted/50 transition-colors">
                    <div className="flex items-start space-x-3">
                      <div className="text-lg">{resourceUtils.getIcon(resource.resource_type)}</div>
                      <div className="flex-1 space-y-1">
                        <div className="flex items-center justify-between">
